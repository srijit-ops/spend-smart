...
export const TextInput=({label, type, placeholder, error, labelStyle, inputStyle, onChange})=> {
  return (
    <div className='my-4 flex flex-col'>
        <label className='text-gray-200 tracking-wider mb-3' style={{...labelStyle}}>{label}</label>
        <input type={type} placeholder={placeholder} onChange={onChange} className='px-4 py-3 mb-3 border border-gray-300 text-white  rounded-md bg-transparent' style={{...inputStyle}}/>
